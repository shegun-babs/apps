<div class="sidebar-nav">
    <ul>
        <li><a href="#" data-target=".mailing-list" class="nav-header collapsed" data-toggle="collapse">
                <i class="fa fa-fw fa-legal"></i> Campaigns<i class="fa fa-collapse"></i></a></li>
        <li>
            <ul class="mailing-list nav nav-list collapse">
                <li><a href="{{route('cp_path')}}"><span class="fa fa-caret-right"></span>Campaign</a></li>
                <li><a href="{{route('ml_path')}}"><span class="fa fa-caret-right"></span>Maling List</a></li>
            </ul>
        </li>
        ...
        <li>
            <ul class="legal-menu nav nav-list collapse">
                ...
                <li><a href="terms-and-conditions.html"><span class="fa fa-caret-right"></span> Terms and Conditions</a>
                </li>
            </ul>
        </li>
